...
export class UserProfileState {
  ...
  loadUserProfileSuccess(ctx: StateContext<UserProfileStateModel>, action: LoadUserProfileSuccess) {
    ...
    const parsedProfile: UserProfile = {
      ...
      hasKids: raw.hasKids === 1 || raw.hasKids === true,
      wantsFriendsWithKids: raw.wantsFriendsWithKids === 1 || raw.wantsFriendsWithKids === true,
      childAgeGroups: raw.childAgeGroups ? JSON.parse(raw.childAgeGroups) : [],
      wantsSimilarChildAges: raw.wantsSimilarChildAges === 1 || raw.wantsSimilarChildAges === true,
